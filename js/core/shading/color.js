...
var Color = (function () {
    ...
    Color.prototype.add = function (value) {
        this.r += value;
        this.g += value;
        this.b += value;
        this.a += value;
    ...
    Color.prototype.addRGB = function (color) {
        this.r += color.r;
        this.g += color.g;
        this.b += color.b;
        this.clamp(0, 255);
    ...
    Color.prototype.multiplyRGB = function (factor) {
        this.r *= factor;
        this.g *= factor;
        this.b *= factor;
        this.clamp(0, 255);
    ...
    Color.getBilinearColor = function (c1, c2, c3, c4, w1, w2, w3, w4, dstColor) {
    ...
    Color.multiplyColor = function (color1, color2, dst) {
